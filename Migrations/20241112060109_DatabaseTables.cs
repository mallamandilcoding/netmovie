    ...
    public partial class DatabaseTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesFeatures", x => x.FeatureId);
                    table.ForeignKey(
                        name: "FK_MoviesFeatures_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WatchlistMovieId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WatchlistMovies", x => x.WatchlistMovieId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesFeatures_MovieId",
                table: "MoviesFeatures",
                column: "MovieId");
